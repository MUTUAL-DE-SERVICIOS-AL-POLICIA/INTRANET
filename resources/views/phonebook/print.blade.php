    ...
    <div class="block">
        ...
        <table class="table-info w-100 m-b-10">
            <thead class="bg-grey-darker">
                <tr class="font-semibold text-white text-md uppercase">
                    <td class="px-15 text-center">Dirección</td>
                    <td class="px-15 text-center">Ubicación</td>
                    <td class="px-15 text-center">Número Interno</td>
                </tr>
            </thead>
            <tbody class="table-striped">
                ...
                <tr class="text-xs">
                    ...
                    <td class="text-center px-5 py-3" rowspan="{{ count($position_group->locations) }}">{{ $position_group->shortened }}</td>
